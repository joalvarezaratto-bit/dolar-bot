...
def comentar(a, noticias=None):
    ...
    datos = (
        ...
        f"Sesgo calculado: {a['sesgo']} (puntaje {a['score']:+d} de -100 a +100).\n"
    ...
    prompt = (
        ...
        "3-5 frases, claro y para alguien sin formacion tecnica: explica el "
        "ESTADO ACTUAL, menciona el RIESGO o REPORTE proximo mas importante si lo "
        "hay, como encajan las noticias, y que niveles/eventos vigilar en las "
        "proximas horas. No inventes datos que no esten aca. No des consejo de inversion "
        "personalizado; habla de escenarios probables. Termina recordando en "
        "media frase que son probabilidades, no certezas.\n\n"
        f"DATOS:\n{datos}"
    )
